...
from Extensions_qt5.Outline.Python import pyclbr
...
class Outline(QtWidgets.QTreeWidget):
    ...
    def updateOutline(self, outlineDict):
        ...
        for obj in objs:
            if obj.objectType == "Class":
                ...
                classItem = QtWidgets.QTreeWidgetItem()
                ...
                for name, lineno in methods:
                    # obj.name, obj.lineno
                    functionItem = QtWidgets.QTreeWidgetItem(classItem)
               ...
               # obj.name, obj.lineno
                functionItem = QtWidgets.QTreeWidgetItem()
               ...
               # obj.name, obj.lineno
                globalItem = QtWidgets.QTreeWidgetItem()
