...
from PyQt5 import QtCore, QtGui, QtPrintSupport, QtWidgets, QtXml
from PyQt5.Qsci import QsciScintilla

from Extensions_qt5.Diff import DiffWindow
from Extensions_qt5.CodeEditor import CodeEditor
from Extensions_qt5.TextEditor import TextEditor
from Extensions_qt5.ViewSwitcher import ViewSwitcher
from Extensions_qt5.TextSnapshot import TextSnapshot
from Extensions_qt5.CodeSnapshot import CodeSnapshot
from Extensions_qt5.GotoLineWidget import GotoLineWidget
from Extensions_qt5.EditorSplitter import EditorSplitter
from Extensions_qt5 import Global
from Extensions_qt5.Refactor.Refactor import Refactor
from Extensions_qt5.BottomWidgets.RunWidget import SetRunParameters
from Extensions_qt5.Projects.ProjectManager.ConfigureProject import ConfigureProject
...
class EditorTabBar(QtWidgets.QTabBar):
    ...
    def setKeymap(self):
        ...
        self.shortSplitFileReload = QtWidgets.QShortcut(
...
class EditorTabWidget(QtWidgets.QTabWidget):
    ...
    def __init__(
        ...
        self.newFileMenu = QtWidgets.QMenu("New File")
    ...
    def createActions(self):
        ...
        #---------------------------------------------------------------------
        self.newPythonFileAct = QtWidgets.QAction(
        ...
        self.saveAsAct = QtWidgets.QAction("Save As...", self, statusTip="Save",
                                       triggered=self.saveAs)

        self.saveCopyAsAct = QtWidgets.QAction("Save Copy As...",
    ...
    def updateOpenedTabsMenu(self):
        self.openedTabsActionGroup = QtWidgets.QActionGroup(self)
    ...
    def openFile(self):
        fileName = QtWidgets.QFileDialog.getOpenFileName(self,
                                                     ...
                                                     "All Files (*);;Console (*.py);;No Console (*.pyw);;Xml (*.xml);;Html (*.html);;Css (*.css)")[0]
        if fileName:
            self.useData.saveLastOpenedDir(os.path.split(fileName)[0])
    ...
    def setKeymap(self):
        ...
        self.shortSplitVertical = QtWidgets.QShortcut(
        ...
        self.shortSplitHorizontal = QtWidgets.QShortcut(
        ...
        self.shortRemoveSplit = QtWidgets.QShortcut(
        ...
        self.shortOpenFile = QtWidgets.QShortcut(
        ...
        self.shortSaveFile = QtWidgets.QShortcut(
        ...
        self.shortSaveAll = QtWidgets.QShortcut(
        ...
        self.shortPrint = QtWidgets.QShortcut(shortcuts["Ide"]["Print"], self)
