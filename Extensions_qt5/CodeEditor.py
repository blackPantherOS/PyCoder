...
from Extensions_qt5.ZoomWidget import ZoomWidget
from Extensions_qt5.Notification import Notification
...
#        self.setAnnotationDisplay(QsciScintilla.AnnotationStandard)
    ...
    def createActions(self):
        ...
        self.takeSnapshotAct = \
            QtWidgets.QAction("Take Snapshot", self,
                          statusTip="Take Snapshot",
                          triggered=self.takeSnapshot)

        self.zoomAct = QtWidgets.QAction(
