...
from Extensions_qt5.FileExplorer import FileExplorer
from Extensions_qt5.BottomWidgets.FindInFiles import FindInFiles
from Extensions_qt5.Projects.ProjectManager.ProjectManager import ProjectManager
from Extensions_qt5.SearchWidget import SearchWidget
from Extensions_qt5.Outline.Outline import Outline
from Extensions_qt5.EditorTabWidget import EditorTabWidget
from Extensions_qt5.WritePad import WritePad
from Extensions_qt5.Favourites import Favourites
from Extensions_qt5.ExternalLauncher import ExternalLauncher
from Extensions_qt5.BottomWidgets.Assistant import Assistant
from Extensions_qt5.BottomWidgets.TasksWidget import Tasks
from Extensions_qt5.BottomWidgets.BookmarkWidget import BookmarkWidget
from Extensions_qt5.BottomWidgets.RunWidget import RunWidget
from Extensions_qt5.BottomWidgets.Messages import MessagesWidget
from Extensions_qt5.StackSwitcher import StackSwitcher
from Extensions_qt5 import StyleSheet
from Extensions_qt5.EditorWindow.BuildStatusWidget import BuildStatusWidget
from Extensions_qt5.EditorWindow.VerticalSplitter import VerticalSplitter
from Extensions_qt5.BottomWidgets.Profiler import Profiler
...
class EditorWindow(QtWidgets.QWidget):
    ...
    def createActions(self):
        ...
        self.userGuideAct = QtWidgets.QAction(
            "User Guide", self, statusTip="User Guide",
                                         triggered=self.launchHelp)

        self.pythonManualsAct = QtWidgets.QAction("Python Manuals", self,
                                              statusTip="Python Manuals",
                                              triggered=self.launchPythonHelp)

        self.checkUpdatesAct = QtWidgets.QAction("Check For Updates", self,
                                             statusTip="Check For Updates",
                                             triggered=self.visitHomepage)

        self.feedbackAct = QtWidgets.QAction("Send Feedback", self,
    ...
    def setKeymap(self):
        ...
        self.shortPythonManuals = QtWidgets.QShortcut(
