...
from Extensions_qt5.Projects.ProjectManager.ProjectView.ProjectView import IconProvider
...
# self.ignoreBadImportsBox.findText(profileData["appendscripttolibrary"]))
        ...
        self.listSelectorBox.addItem("Extensions_qt5")
...
#        self.listSelectorBox.currentIndexChanged.connect(self.viewList)
        ...
        self.helpDict = {
            "Extensions_qt5": "Specify which files should be considered python files.",
