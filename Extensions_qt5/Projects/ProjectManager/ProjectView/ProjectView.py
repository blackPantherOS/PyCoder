...
from Extensions_qt5.Projects.ProjectManager.ProjectView.ProgressWidget import ProgressWidget
...
class ProjectTree(QtWidgets.QTreeView):
    ...
    def createActions(self):
        self.addFileAct = QtWidgets.QAction(
            "File", self,
            statusTip="File", triggered=self.newFile)

        self.addDirAct = QtWidgets.QAction(
            "Directory", self,
            statusTip="Directory", triggered=self.newDirectory)

        self.addPackageAct = QtWidgets.QAction(
        ...
        self.mainScriptsAct = QtWidgets.QAction(
