...
from rope.contrib.findit import (find_occurrences, find_implementations,
                                 find_definition)
from Extensions_qt5.Refactor.UsageDialog import UsageDialog
...
class Refactor(QtWidgets.QWidget):
    ...
    def createActions(self):
        ...
        self.findOccurrencesAct = \
            QtWidgets.QAction("Usages", self, statusTip="Usages",
        ...
        self.renameModuleAct = \
            QtWidgets.QAction("Rename", self, statusTip="Rename",
        ...
        self.inlineAct = \
            QtWidgets.QAction("Inline", self, statusTip="Inline",
                          triggered=self.inline)

        self.localToFieldAct = \
            QtWidgets.QAction("Local-to-Field", self, statusTip="Local-to-Field",
